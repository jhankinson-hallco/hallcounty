<# 
.SYNOPSIS
    Uninstall-MobileCAD-SO.ps1
    Uninstalls Mobile CAD SO Client by removing files and shortcuts.

.DESCRIPTION
    1. Stops VMLaunch process if running
    2. Removes SO.Classic.lnk from Public Desktop
    3. Removes SO.Classic.lnk from Startup folder
    4. Removes C:\Mobile Client SO folder
    
    Logs ONLY on failure to C:\IntuneAppLogs\MobileCAD-SO_Uninstall.txt
