...
<#
.SYNOPSIS
    Writes the PDQ marker for the Print Management Console capability.
...
.NOTES
    ...
    Purpose:        Write the PDQ marker for the Print Management Console capability
    ...
    PDQ CONFIGURATION
      ...
      Install-PrintManagementConsole-PDQ.ps1 v1.0.3.
...
$script:MarkerPath    = Join-Path -Path $script:MarkerRoot -ChildPath 'PrintManagementConsole.marker'
