...
<#
.SYNOPSIS
    Intune detection script for the ADP (Workforce Now) Public Desktop shortcut.
...
.NOTES
    ...
    Purpose:        Detect the ADP (Workforce Now) shortcut with IME or legacy icon location
...
# Configuration - must match Install-ADPShortcut.ps1 exactly
