...
<#
.SYNOPSIS
    Updates the icon of the existing ADP (Workforce Now) shortcut on the Public Desktop.
...
.DESCRIPTION
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_ADPShortcut_IconUpdate.txt.
...
.NOTES
    ...
    Purpose:        Refresh the ADP (Workforce Now) shortcut icon from the network share
