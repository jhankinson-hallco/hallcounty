...
<#
.SYNOPSIS
    Intune detection script for the EPR Fireworks Public Desktop shortcut.
...
.NOTES
    ...
    Purpose:        Detect the EPR Fireworks shortcut with IME or legacy icon location
...
# Configuration - must match Install-EPRFireworksShortcut.ps1 exactly
