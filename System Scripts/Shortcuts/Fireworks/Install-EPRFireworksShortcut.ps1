...
<#
.SYNOPSIS
    Deploys the EPR Fireworks shortcut to the Public Desktop and sets its custom icon.
...
.DESCRIPTION
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_EPRFireworksShortcut_Install.txt.
...
.NOTES
    ...
    Purpose:        Deploy the EPR Fireworks Public Desktop shortcut with custom icon
    ...
    INTUNE CONFIGURATION
      Install command:
        %SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoProfile -NonInteractive -File .\Install-EPRFireworksShortcut.ps1
      Uninstall command:
        %SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoProfile -NonInteractive -File .\Uninstall-EPRFIreworksShortcut.ps1
...
$script:AppName          = 'EPRFireworksShortcut'
$script:ShortcutFileName = 'EPR Fireworks.url'
$script:IconFileName     = 'Fireworks Icon.ico'
