...
<#
.SYNOPSIS
    PDQ deployment: installs the EPR Fireworks shortcut to the Public Desktop with its custom icon.

.DESCRIPTION
    PDQ Deploy installation script. Tandem counterpart of the Intune Win32 app
    Install-EPRFireworksShortcut.ps1 (v1.1.1). Pulls the shortcut and icon from the shared
...
.NOTES
    ...
    Purpose:        Deploy the EPR Fireworks Public Desktop shortcut with custom icon via PDQ
    ...
    Change: 13/07/2026 - Initial PDQ release, tandem with Intune Install-EPRFireworksShortcut.ps1 v1.1.0 -- ver. 1.0.0
