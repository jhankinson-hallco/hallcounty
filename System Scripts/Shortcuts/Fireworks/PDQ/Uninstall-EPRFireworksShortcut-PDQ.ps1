...
<#
.SYNOPSIS
    PDQ deployment: removes the EPR Fireworks shortcut from the Public Desktop.

.DESCRIPTION
    PDQ Deploy uninstallation script. Tandem counterpart of the Intune Win32
    uninstall Uninstall-EPRFIreworksShortcut.ps1 (v1.1.1); the on-device result is identical.
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_EPRFireworksShortcut_Uninstall.txt
...
.NOTES
    ...
    Purpose:        Remove the EPR Fireworks Public Desktop shortcut via PDQ
    ...
    Change: 13/07/2026 - Initial PDQ release, tandem with Intune Uninstall-EPRFIreworksShortcut.ps1 v1.1.0 -- ver. 1.0.0
