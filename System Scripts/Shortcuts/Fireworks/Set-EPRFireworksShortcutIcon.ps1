...
<#
.SYNOPSIS
    Updates the icon of the existing EPR Fireworks shortcut on the Public Desktop.
...
.DESCRIPTION
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_EPRFireworksShortcut_IconUpdate.txt.
...
.NOTES
    ...
    Purpose:        Refresh the EPR Fireworks shortcut icon from the network share
