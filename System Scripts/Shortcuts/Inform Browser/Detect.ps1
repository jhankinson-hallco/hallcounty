...
<#
.SYNOPSIS
    Intune detection script for the Inform Browser Public Desktop shortcut.
...
.NOTES
    ...
    Purpose:        Detect the Inform Browser shortcut with IME or legacy icon location
...
# Configuration - must match Install-InformBrowserShortcut.ps1 exactly
