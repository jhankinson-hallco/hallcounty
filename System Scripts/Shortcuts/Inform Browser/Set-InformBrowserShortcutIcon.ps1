...
<#
.SYNOPSIS
    Updates the icon of the existing Inform Browser shortcut on the Public Desktop.
...
.DESCRIPTION
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_InformBrowserShortcut_IconUpdate.txt.
...
.NOTES
    ...
    Purpose:        Refresh the Inform Browser shortcut icon from the network share
