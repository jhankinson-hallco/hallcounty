...
<#
.SYNOPSIS
    Deploys the Microsoft Account Settings shortcut to the Public Desktop and sets its custom icon.
...
.DESCRIPTION
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_MicrosoftAccountShortcut_Install.txt.
...
.NOTES
    ...
    Purpose:        Deploy the Microsoft Account Settings Public Desktop shortcut with custom icon
    ...
    INTUNE CONFIGURATION
      Install command:
        %SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoProfile -NonInteractive -File .\Install-MicrosoftAccountShortcut.ps1
      Uninstall command:
        %SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoProfile -NonInteractive -File .\Uninstall-MicrosoftAccountShortcut.ps1
...
$script:AppName          = 'MicrosoftAccountShortcut'
