...
<#
.SYNOPSIS
    PDQ deployment: installs the Microsoft Account Settings shortcut to the Public Desktop with its custom icon.

.DESCRIPTION
    PDQ Deploy installation script. Tandem counterpart of the Intune Win32 app
    Install-MicrosoftAccountShortcut.ps1 (v1.1.1). Pulls the shortcut and icon from the shared
...
.NOTES
    ...
    Purpose:        Deploy the Microsoft Account Settings Public Desktop shortcut with custom icon via PDQ
    ...
    Change: 13/07/2026 - Initial PDQ release, tandem with Intune Install-MicrosoftAccountShortcut.ps1 v1.1.0 -- ver. 1.0.0
