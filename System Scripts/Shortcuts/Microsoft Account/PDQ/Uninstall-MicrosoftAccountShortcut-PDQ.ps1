...
<#
.SYNOPSIS
    PDQ deployment: removes the Microsoft Account Settings shortcut from the Public Desktop.

.DESCRIPTION
    PDQ Deploy uninstallation script. Tandem counterpart of the Intune Win32
    uninstall Uninstall-MicrosoftAccountShortcut.ps1 (v1.1.1); the on-device result is identical.
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_MicrosoftAccountShortcut_Uninstall.txt
...
.NOTES
    ...
    Purpose:        Remove the Microsoft Account Settings Public Desktop shortcut via PDQ
    ...
    Change: 13/07/2026 - Initial PDQ release, tandem with Intune Uninstall-MicrosoftAccountShortcut.ps1 v1.1.0 -- ver. 1.0.0
