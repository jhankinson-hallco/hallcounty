...
<#
.SYNOPSIS
    Updates the icon of the existing Microsoft Account Settings shortcut on the Public Desktop.
...
.DESCRIPTION
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_MicrosoftAccountShortcut_IconUpdate.txt.
...
.NOTES
    ...
    Purpose:        Refresh the Microsoft Account Settings shortcut icon from the network share
