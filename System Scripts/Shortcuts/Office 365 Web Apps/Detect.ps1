...
<#
.SYNOPSIS
    Intune detection script for the Office 365 Web Apps Public Desktop shortcut.
...
.NOTES
    ...
    Purpose:        Detect the Office 365 Web Apps shortcut with IME or legacy icon location
...
# Configuration - must match Install-Office365WebAppsShortcut.ps1 exactly
