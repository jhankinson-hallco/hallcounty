...
<#
.SYNOPSIS
    Deploys the Office 365 Web Apps shortcut to the Public Desktop and sets its custom icon.
...
.DESCRIPTION
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_Office365WebAppsShortcut_Install.txt.
...
.NOTES
    ...
    Purpose:        Deploy the Office 365 Web Apps Public Desktop shortcut with custom icon
    ...
    INTUNE CONFIGURATION
      Install command:
        %SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoProfile -NonInteractive -File .\Install-Office365WebAppsShortcut.ps1
      Uninstall command:
        %SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoProfile -NonInteractive -File .\Uninstall-Office365WebAppsShortcut.ps1
...
$script:AppName          = 'Office365WebAppsShortcut'
$script:ShortcutFileName = 'Office 365 Web Apps.url'
$script:IconFileName     = 'Office 365 Web App Icon.ico'
