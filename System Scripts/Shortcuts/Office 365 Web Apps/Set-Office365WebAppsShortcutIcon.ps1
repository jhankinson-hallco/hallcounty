...
<#
.SYNOPSIS
    Updates the icon of the existing Office 365 Web Apps shortcut on the Public Desktop.
...
.DESCRIPTION
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_Office365WebAppsShortcut_IconUpdate.txt.
...
.NOTES
    ...
    Purpose:        Refresh the Office 365 Web Apps shortcut icon from the network share
