...
<#
.SYNOPSIS
    Intune detection script for the Operative IQ Public Desktop shortcut.
...
.NOTES
    ...
    Purpose:        Detect the Operative IQ shortcut with IME or legacy icon location
...
# Configuration - must match Install-OperativeIQShortcut.ps1 exactly
