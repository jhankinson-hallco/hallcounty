...
<#
.SYNOPSIS
    Deploys the Operative IQ shortcut to the Public Desktop and sets its custom icon.
...
.NOTES
    ...
    Purpose:        Deploy the Operative IQ Public Desktop shortcut with custom icon
    ...
    INTUNE CONFIGURATION
      Install command:
        %SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoProfile -NonInteractive -File .\Install-OperativeIQShortcut.ps1
      Uninstall command:
        %SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoProfile -NonInteractive -File .\Uninstall-OperativeIQShortcut.ps1
