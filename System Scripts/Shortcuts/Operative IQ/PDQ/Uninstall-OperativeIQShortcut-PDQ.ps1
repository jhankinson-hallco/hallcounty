...
<#
.SYNOPSIS
    PDQ deployment: removes the Operative IQ shortcut from the Public Desktop.

.DESCRIPTION
    PDQ Deploy uninstallation script. Tandem counterpart of the Intune Win32
    uninstall Uninstall-OperativeIQShortcut.ps1 (v1.1.1); the on-device result is identical.
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_OperativeIQShortcut_Uninstall.txt
...
.NOTES
    ...
    Purpose:        Remove the Operative IQ Public Desktop shortcut via PDQ
    ...
    Change: 13/07/2026 - Initial PDQ release, tandem with Intune Uninstall-OperativeIQShortcut.ps1 v1.1.0 -- ver. 1.0.0
