...
<#
.SYNOPSIS
    Intune detection script for the Example App Public Desktop shortcut.
...
.NOTES
    ...
    Purpose:        Detect the Example App shortcut with IME or legacy icon location
...
# Configuration - must match Install-Shortcut.ps1 exactly
