...
<#
.SYNOPSIS
    PDQ deployment: installs the Example App shortcut to the Public Desktop with its custom icon.

.DESCRIPTION
    PDQ Deploy installation script. Tandem counterpart of the Intune Win32 app
    Install-Shortcut.ps1 (v1.1.1). Pulls the shortcut and icon from the shared
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_ExampleShortcut_Install.txt
...
.NOTES
    ...
    Purpose:        Deploy the Example App Public Desktop shortcut with custom icon via PDQ
    ...
    Change: 13/07/2026 - Initial PDQ release, tandem with Intune Install-Shortcut.ps1 v1.1.0 -- ver. 1.0.0
