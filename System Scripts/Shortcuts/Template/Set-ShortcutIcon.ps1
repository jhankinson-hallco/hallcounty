...
<#
.SYNOPSIS
    Updates the icon of the existing Example App shortcut on the Public Desktop.
...
.DESCRIPTION
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_ExampleShortcut_IconUpdate.txt.
...
.NOTES
    ...
    Purpose:        Refresh the Example App shortcut icon from the network share
