...
<#
.SYNOPSIS
    Intune detection script for the Webmail Public Desktop shortcut.
...
.NOTES
    ...
    Purpose:        Detect the Webmail shortcut with IME or legacy icon location
...
# Configuration - must match Install-WebmailShortcut.ps1 exactly
