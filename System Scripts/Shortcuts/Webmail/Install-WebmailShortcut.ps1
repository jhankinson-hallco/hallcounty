...
<#
.SYNOPSIS
    Deploys the Webmail shortcut to the Public Desktop and sets its custom icon.
...
.NOTES
    ...
    Purpose:        Deploy the Webmail Public Desktop shortcut with custom icon
    ...
    INTUNE CONFIGURATION
      Install command:
        %SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoProfile -NonInteractive -File .\Install-WebmailShortcut.ps1
      Uninstall command:
