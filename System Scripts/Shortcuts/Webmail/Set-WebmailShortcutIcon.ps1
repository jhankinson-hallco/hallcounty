...
<#
.SYNOPSIS
    Updates the icon of the existing Webmail shortcut on the Public Desktop.
...
.DESCRIPTION
    ...
    C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\SCRIPT_WebmailShortcut_IconUpdate.txt.
...
.NOTES
    ...
    Purpose:        Refresh the Webmail shortcut icon from the network share
