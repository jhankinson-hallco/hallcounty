...
Copy-RecentFiles -SourceRoot 'C:\ProgramData\Microsoft\IntuneManagementExtension\Images'      -DestRoot (Join-Path $outRoot 'IMEImages')          -ThresholdUtc $startUtc
Copy-RecentFiles -SourceRoot 'C:\ProgramData\Microsoft\IntuneManagementExtension\ScriptFiles' -DestRoot (Join-Path $outRoot 'IMEScriptFiles')     -ThresholdUtc $startUtc
...
Copy-RecentFiles -SourceRoot 'C:\IntuneAppLogs'                                              -DestRoot (Join-Path $outRoot 'Legacy_IntuneAppLogs')       -ThresholdUtc $startUtc
Copy-RecentFiles -SourceRoot 'C:\IntuneScriptLogs'                                           -DestRoot (Join-Path $outRoot 'Legacy_IntuneScriptLogs')    -ThresholdUtc $startUtc
Copy-RecentFiles -SourceRoot 'C:\IntuneDeploymentFiles'                                      -DestRoot (Join-Path $outRoot 'Legacy_IntuneDeploymentFiles') -ThresholdUtc $startUtc
Copy-RecentFiles -SourceRoot 'C:\IntuneScripts'                                              -DestRoot (Join-Path $outRoot 'Legacy_IntuneScripts')       -ThresholdUtc $startUtc
...
if (Test-Path -LiteralPath 'C:\ProgramData\Microsoft\IntuneManagementExtension\AppMarkers' -PathType Container) {
    $markerDest = Join-Path $outRoot 'IMEAppMarkers'
    New-Item -ItemType Directory -Path $markerDest -Force | Out-Null
    Copy-Item -Path 'C:\ProgramData\Microsoft\IntuneManagementExtension\AppMarkers\*' -Destination $markerDest -Recurse -Force -ErrorAction SilentlyContinue
}

if (Test-Path -LiteralPath 'C:\IntuneAppMarkers' -PathType Container) {
    $markerDest = Join-Path $outRoot 'Legacy_IntuneAppMarkers'
    New-Item -ItemType Directory -Path $markerDest -Force | Out-Null
